#!/usr/bin/env bash
# ==============================================================================
# Ubuntu Optimizations - Setup Script
# ==============================================================================
set -e
...
log_info "Starting Ubuntu system optimizations setup..."
...
for dir in "$SCRIPT_DIR"/*/; do
    ...
    if [[ -f "$dir/install.sh" ]]; then
        ...
        log_info "Executing configuration script for module: ${BOLD}$dir_name${NC}"
