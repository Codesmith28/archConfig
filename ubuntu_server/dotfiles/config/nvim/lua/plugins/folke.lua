        ...
        layouts = {
          my_telescope_style = {
            layout = {
              ...
              { win = "preview", title = " {preview} ", title_pos = "center", border = "rounded", width = 0.60 },
            },
          },
        },
      ...
      styles = {
        ...
        my_telescope_style = {
          layout = {
            ...
            { win = "preview", title = " {preview} ", title_pos = "center", border = "rounded", width = 0.60 }, -- 2:3 ratio layout
          },
        },
